...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        <a href="{{ route('pimpinan.pengajuan.index') }}" class="btn btn-sm btn-secondary">
...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('pimpinan.pengajuan.approve', $pengajuan) }}">
                    @csrf @method('PUT')
                    <button type="submit" class="btn btn-success btn-lg w-100 mb-3" onclick="return confirm('Setujui pengajuan ini?')">
                        <i class="fas fa-check-circle me-2"></i>Setujui
                    </button>
                </form>
                <form method="POST" action="{{ route('pimpinan.pengajuan.reject', $pengajuan) }}">
                    @csrf @method('PUT')
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-danger btn-lg w-100" onclick="return confirm('Tolak pengajuan ini?')">
